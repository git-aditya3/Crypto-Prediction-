      ...
      <div className="relative max-w-[1600px] mx-auto p-6 space-y-8">
        <div>
          <h1 className="text-3xl font-black tracking-tight flex items-center gap-3">
            <span className="w-10 h-10 rounded-xl theme-bg dark:bg-white flex items-center justify-center shadow-lg">
              <Brain size={20} className="text-black" />
            </span>
            <span className="text-[var(--text)]">Model Zoo • v2</span>
            <span className="px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 border border-black/5 dark:border-white/5 text-zinc-900 dark:text-[var(--text)] text-xs font-bold tracking-widest">4 MODELS + ENSEMBLE</span>
          </h1>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${model.color} flex items-center justify-center shadow-lg`}>
                    <model.icon size={20} className="text-[var(--text)]" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="font-black text-[var(--text)] text-lg tracking-tight">{model.name}</h3>
                      {model.badge && (
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm font-black text-[var(--text)] mono">{model.performance}</div>
                </div>
              </div>
              
              <p className="text-sm text-[var(--text)]/70 leading-relaxed mb-4">{model.description}</p>
        ...
        <GlassCard className="p-8 border-black/5 dark:border-white/5 bg-gradient-to-br from-crypto-accent/5 via-crypto-card/50 to-crypto-accent2/5">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 rounded-2xl theme-bg dark:bg-white flex items-center justify-center shadow-xl shadow-sm">
              <Layers size={24} className="text-black" />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h3 className="font-black text-[var(--text)] text-xl tracking-tight">Ensemble Strategy</h3>
                <span className="px-3 py-1 rounded-full bg-[var(--accent)] text-black text-xs font-black tracking-widest">PRODUCTION</span>
              </div>
              <p className="text-[var(--text)]/70 leading-relaxed mb-6">Weighted combination: LSTM 35% + Transformer 35% + XGBoost 20% + ARIMA 10%. Configurable in config.py. Future forecast uses autoregressive approximation for multi-step prediction. Provides robust predictions by combining strengths of each model.</p>
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <div key={m.name} className="p-3 rounded-xl bg-transparent/50 border border-black/5 dark:border-white/5/30 text-center">
                    <div className={`w-8 h-8 mx-auto mb-2 rounded-lg bg-gradient-to-br ${m.color} flex items-center justify-center text-[var(--text)] font-black text-xs`}>
                      {m.weight}
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <GlassCard className="p-6">
            <h3 className="font-bold text-[var(--text)] mb-4 flex items-center gap-2">
              <Database size={16} className="text-zinc-900 dark:text-[var(--text)]" />
              Feature Engineering
            </h3>
          ...
          <GlassCard className="p-6">
            <h3 className="font-bold text-[var(--text)] mb-4 flex items-center gap-2">
              <GitBranch size={16} className="text-zinc-900 dark:text-[var(--text)]" />
              Training Pipeline
            </h3>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs p-2 rounded-lg bg-transparent border border-black/5 dark:border-white/5">
                ...
                <span className="text-[var(--text)] font-bold">20%</span>
              </div>
              <div className="flex justify-between text-xs p-2 rounded-lg bg-transparent border border-black/5 dark:border-white/5">
                <span className="text-zinc-500">Val Size</span>
                <span className="text-[var(--text)] font-bold">10%</span>
              </div>
              <div className="flex justify-between text-xs p-2 rounded-lg bg-transparent border border-black/5 dark:border-white/5">
                <span className="text-zinc-500">Sequence</span>
                <span className="text-[var(--text)] font-bold">60 days</span>
              </div>
            </div>
          </GlassCard>
        </div>
        ...
        <GlassCard className="p-6">
          <h3 className="font-bold text-[var(--text)] mb-4 flex items-center gap-2">
            <Cpu size={16} className="text-zinc-900 dark:text-[var(--text)]" />
            Realtime & Backtesting
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <div className="text-sm font-bold text-[var(--text)] mb-2">Binance Realtime</div>
            ...
            <div>
              <div className="text-sm font-bold text-[var(--text)] mb-2">Backtesting</div>
