  ...
  return (
    <div className={`min-h-screen font-poppins ${isDark ? 'bg-black' : 'bg-[#E3EDF7]'}`}>
      <div className="max-w-[1600px] mx-auto p-4 md:p-6 space-y-6">
        <div>
          <h1 className={`text-2xl font-bold flex items-center gap-3 ${isDark ? 'text-white' : 'text-black'}`}><Bot size={20} /> Trading Bots • Institutional</h1>
        ...
        <div className="ui-card p-4 border border-emerald-500/20">
          <div className="flex items-center gap-2 mb-2"><Shield size={16} className="text-emerald-500" /><span className={`font-bold text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>Institutional Research Integrated</span><span className="ui-pill-live text-[9px]">INSTITUTIONAL</span></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3">
          <div className="ui-card p-4">
            ...
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>DCA Bot</h3>
            <p className="text-[11px] text-zinc-500 mt-1">Buy dips below market</p>
            <button onClick={() => setShowDCA(true)} className="mt-3 w-full py-2 rounded-xl bg-black dark:bg-white text-white text-[11px] font-bold flex items-center justify-center gap-1"><Plus size={12} /> Create</button>
          </div>
          <div className="ui-card p-4">
            <Grid3X3 size={18} className={isDark ? 'text-white' : 'text-black'} />
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>Grid Bot</h3>
            <p className="text-[11px] text-zinc-500 mt-1">Ranging market profits</p>
            <button onClick={() => setShowGrid(true)} className="mt-3 w-full py-2 rounded-xl bg-black dark:bg-white text-white text-[11px] font-bold flex items-center justify-center gap-1"><Plus size={12} /> Create</button>
          </div>
          <div className="ui-card p-4 border border-emerald-500/20">
            <Layers size={18} className="text-emerald-500" />
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>Market Making</h3>
          ...
          <div className="ui-card p-4">
            <BarChart3 size={18} className={isDark ? 'text-white' : 'text-black'} />
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>TWAP/VWAP</h3>
            <p className="text-[11px] text-zinc-500 mt-1">Execution algos</p>
            <button onClick={() => setShowExec(true)} className="mt-3 w-full py-2 rounded-xl bg-black dark:bg-white text-white text-[11px] font-bold flex items-center justify-center gap-1"><Plus size={12} /> Execute</button>
          </div>
          <div className="ui-card p-4">
            <Repeat size={18} className={isDark ? 'text-white' : 'text-black'} />
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>Stat Arb</h3>
            <p className="text-[11px] text-zinc-500 mt-1">Pairs cointegration</p>
            <button onClick={() => setShowStat(true)} className="mt-3 w-full py-2 rounded-xl bg-black dark:bg-white text-white text-[11px] font-bold flex items-center justify-center gap-1"><Plus size={12} /> Pair</button>
          </div>
          <div className="ui-card p-4">
            <Activity size={18} className="text-amber-600" />
            <h3 className={`font-bold mt-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}>OFI Scanner</h3>
        ...
        <div className="ui-card p-5">
          <h3 className={`font-bold mb-4 text-[14px] ${isDark ? 'text-white' : 'text-black'}`}>Active Bots • Real Trading ({bots?.count ?? 0}) • Institutional Included</h3>
          {!bots || (bots.count ?? 0) === 0 ? (
        ...
        {institutional && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="ui-card p-4">
              <h4 className={`font-bold text-[12px] mb-3 flex items-center gap-1.5 ${isDark ? 'text-white' : 'text-black'}`}><Activity size={12} /> OrderBook Imbalance</h4>
              <div className="space-y-2">
                {(institutional.orderbook_imbalance || []).slice(0,3).map((s,i)=>(
                  <div key={i} className={`p-2 rounded-lg border text-[11px] flex justify-between ${isDark ? 'bg-black border-white/5' : 'bg-white border-black/5'}`}>
            ...
            <div className="ui-card p-4">
              <h4 className={`font-bold text-[12px] mb-3 flex items-center gap-1.5 ${isDark ? 'text-white' : 'text-black'}`}><Coins size={12} /> Funding Arb</h4>
              <div className="space-y-2">
            ...
            <div className="ui-card p-4">
              <h4 className={`font-bold text-[12px] mb-3 flex items-center gap-1.5 ${isDark ? 'text-white' : 'text-black'}`}><Layers size={12} /> Market Making</h4>
              <div className="space-y-2">
                {(institutional.market_making || []).slice(0,3).map((s,i)=>(
                  <div key={i} className={`p-2 rounded-lg border text-[11px] ${isDark ? 'bg-black border-white/5' : 'bg-white border-black/5'}`}>
            ...
            <div className="ui-card p-4">
              <h4 className={`font-bold text-[12px] mb-3 flex items-center gap-1.5 ${isDark ? 'text-white' : 'text-black'}`}><Repeat size={12} /> Stat Arb Pairs</h4>
              <div className="space-y-2">
        ...
        {/* Breakouts */}
        <div className="ui-card p-5">
          <h3 className={`font-bold mb-4 flex items-center gap-2 text-[13px] ${isDark ? 'text-white' : 'text-black'}`}><Zap size={14} /> Breakout Signals • Volume Confirmed</h3>
          {breakouts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {breakouts.map((b, i) => (
                <div key={i} className={`p-3 rounded-xl border text-[11px] ${b.signal?.includes('BUY') ? 'bg-emerald-500/5 border-emerald-500/20' : b.signal?.includes('SELL') ? 'bg-red-500/5 border-red-500/10' : 'bg-zinc-50 dark:bg-zinc-900 border-black/5 dark:border-white/5'}`}>
                  <div className="flex justify-between"><span className="font-bold">{b.symbol}</span><span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${b.signal?.includes('BUY') ? 'bg-emerald-500 text-black' : b.signal?.includes('SELL') ? 'bg-red-500 text-white' : 'ui-pill'}`}>{b.signal}</span></div>
        ...
        {showDCA && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
            <div className="ui-card w-full max-w-md p-5">
              <h3 className={`font-bold mb-4 ${isDark ? 'text-white' : 'text-black'}`}>Create DCA Bot</h3>
              <div className="space-y-2">
                ...
                <div className="flex gap-2"><button onClick={() => setShowDCA(false)} className="flex-1 py-2 rounded-xl ui-card">Cancel</button><button onClick={createDCA} className="flex-1 py-2 rounded-xl bg-black dark:bg-white text-white font-bold">Create</button></div>
              </div>
            </div>
          </div>
        )}
        {showGrid && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
            <div className="ui-card w-full max-w-md p-5">
              <h3 className={`font-bold mb-4 ${isDark ? 'text-white' : 'text-black'}`}>Create Grid Bot</h3>
              <div className="space-y-2">
                ...
                <div className="flex gap-2"><button onClick={() => setShowGrid(false)} className="flex-1 py-2 rounded-xl ui-card">Cancel</button><button onClick={createGrid} className="flex-1 py-2 rounded-xl bg-black dark:bg-white text-white font-bold">Create</button></div>
              </div>
            </div>
          </div>
        )}
        {showMM && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
            <div className="ui-card w-full max-w-md p-5 border border-emerald-500/20">
              <h3 className={`font-bold mb-2 flex items-center gap-2 ${isDark ? 'text-white' : 'text-black'}`}><Layers size={16} className="text-emerald-500" /> Market Making • Avellaneda-Stoikov</h3>
        ...
        {showExec && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
            <div className="ui-card w-full max-w-md p-5">
              <h3 className={`font-bold mb-2 ${isDark ? 'text-white' : 'text-black'}`}>TWAP/VWAP Execution</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2"><button onClick={() => setShowExec(false)} className="flex-1 py-2 rounded-xl ui-card">Cancel</button><button onClick={createExec} className="flex-1 py-2 rounded-xl bg-black dark:bg-white text-white font-bold">Execute {execForm.strategy}</button></div>
              </div>
            </div>
          </div>
        )}
        {showStat && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
            <div className="ui-card w-full max-w-md p-5">
              <h3 className={`font-bold mb-2 ${isDark ? 'text-white' : 'text-black'}`}>Stat Arb • Pairs Trading</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2"><button onClick={() => setShowStat(false)} className="flex-1 py-2 rounded-xl ui-card">Cancel</button><button onClick={createStat} className="flex-1 py-2 rounded-xl bg-black dark:bg-white text-white font-bold">Create Pair</button></div>
              </div>
            </div>
          </div>
        )}
