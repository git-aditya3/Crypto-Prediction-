            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold">CryptoPred v4 • Real Trading • Endless Learning</span>
                </div>
                <div className="hidden md:flex items-center gap-2 text-xs text-crypto-muted">
                  ...
                  <span className="px-2 py-1 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-400">Continuous Training • Live</span>
                </div>
              </div>
              <div className="flex items-center gap-6 text-xs text-crypto-muted">
                <span>Real Trading Calls • No Fake Simulation • Live Binance</span>
